...
*   project) and slave (CE216628_I2C_Slave_S6E1A). The master periodically
...
int main(void)
{
    ...
    /* Select the I2C pins and enable pull-up resistors in P52 and P51 */
    Master_SetPinFunc_SCL();
    Master_SetPinFunc_SDA();
    
    bFM_GPIO_PCR5_P2 = PULLUP;
    bFM_GPIO_PCR5_P1 = PULLUP;
